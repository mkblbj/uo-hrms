...
from hrms.hr.doctype.shift_type.shift_type import calculate_lunch_overlap_hours, round_time_to_precision
...
def debug_record(employee_name, date_str):
	...
	att = frappe.get_all(
		"Attendance",
		filters={"employee_name": employee_name, "attendance_date": date_str, "docstatus": 1},
		fields=["*"],
	)
